...
\textbf{TODO: by constraining $p_C$ and $p_Z$ to lie on two different parallel
planes we obtain the 2D LIPM. Typically, $z_Z$ is constrained to lie on the
ground and $z_C$ is constraint to lie on a plane displaced by $h$.
We have $\eta^2=g/h$.}
