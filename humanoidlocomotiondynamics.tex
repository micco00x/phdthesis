...
contact point $\bm{p}_{f,k}\in\mathbb{R}^3$. Unilaterality of contact is formally
defined by
\begin{equation*}
    \bm{n}_k^T \bm{f}_k > 0,
\end{equation*}
...
the $k$-th contact point $\bm{p}_{f,k}$. Note that the structure of the
...
i.e., they must not roll or slide. A contact force $\bm{f}_k$ is
...
\eqref{eq:LIPM-xy}, the supporting region becomes the \textit{support
