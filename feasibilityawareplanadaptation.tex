...
\begin{figure}
    \centering
    \includegraphics[trim={0.5cm 1.5cm 2cm 0.1cm},clip,width= \columnwidth]{figures/strobo-staircase-with-pushes.png}
...
\begin{figure}
    \centering
    \includegraphics[width= 0.75\columnwidth]{figures/balance3d.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\columnwidth]{figures/humanoids_kinconstr.pdf}
...
\begin{figure}
    %\includegraphics[trim={0 1cm 0 0},clip,width=\columnwidth]{figures/empty-fixed-plot-starting.pdf}
    \centering
    \includegraphics[trim={0 5.9cm 0 0.7cm},clip,width=\columnwidth]{figures/empty-fixed-plot-after-push.pdf}
    \includegraphics[trim={0 5.9cm 0 0.7cm},clip,width=\columnwidth]{figures/empty-fixed-plot-completing-task.pdf}
    \includegraphics[trim={0 2.2cm 0 8.6cm},clip,width=\columnwidth]{figures/empty-fixed-plot-completing-task.pdf}
...
\begin{figure}
    %\includegraphics[trim={0 1cm 0 0},clip,width=\columnwidth]{figures/two-patches-fixed-plot-starting.pdf}
    \centering
    \includegraphics[trim={0 5.9cm 0 0.7cm},clip,width=\columnwidth]{figures/two-patches-fixed-plot-after-push.pdf}
    \includegraphics[trim={0 5.9cm 0 0.7cm},clip,width=\columnwidth]{figures/two-patches-fixed-completing-task.pdf}
    \includegraphics[trim={0 2.2cm 0 8.6cm},clip,width=\columnwidth]{figures/two-patches-fixed-completing-task.pdf}
...
\begin{figure}
    %\includegraphics[trim={0 1cm 0 0},clip,width=\columnwidth]{figures/two-patches-mixed-integer-plot-starting.pdf}
    \centering
    \includegraphics[trim={0 5.9cm 0 0.7cm},clip,width=\columnwidth]{figures/two-patches-mixed-integer-after-push.pdf}
    \includegraphics[trim={0 5.9cm 0 0.7cm},clip,width=\columnwidth]{figures/two-patches-mixed-integer-completing-task.pdf}
    \includegraphics[trim={0 2.2cm 0 8.6cm},clip,width=\columnwidth]{figures/two-patches-mixed-integer-completing-task.pdf}
...
%\begin{figure}
    %\centering
    %\includegraphics[width=\columnwidth]{figures/empty-fixed-strobo.png}
...
%\begin{figure}
    %\centering
    %\includegraphics[width=\columnwidth]{figures/two-patches-fixed-strobo.png}
...
%\begin{figure}
    %\centering
    %\includegraphics[trim={0 0cm 0 0cm},clip,width=\columnwidth]{figures/strobo-staircase-with-pushes.png}
    %\caption{Stroboscopic view of Simulation 4: V-FAPA in the {\em stairs} scenario. Red arrows indicate impulsive pushes.}
    %\label{fig:FAPA:two-patches-mixed-integer-snapshots}
%\end{figure}
